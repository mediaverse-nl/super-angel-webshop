                ...
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="custom-cont rol custom-checkbox mb-3">
                                {{--<input type="checkbox" class="custom-control-input" id="customCheck1">--}}
                                <input type="checkbox" class="custom-control- " style="opacity: 1 !important;" name="remember" {{ old('remember') ? 'checked' : '' }}>
                            ...
                            <a href="{!! route('login.redirect', 'facebook') !!}" class="btn btn-lg btn-facebook btn-block text-uppercase">
                                <i class="fa fa-facebook-square"></i> Inloggen met Facebook
                            </a>
